...
export function useFailureAnalysis(filters: AnalyticsFilterParams = {}) {
  return useQuery({
    queryKey: analyticsQueryKeys.errorsFailures(filters),
    queryFn: () => errorAnalyticsApi.getFailureAnalysis(filters),
