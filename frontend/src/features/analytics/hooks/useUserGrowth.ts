...
export function useUserGrowth(filters: AnalyticsFilterParams = {}) {
  return useQuery({
    queryKey: analyticsQueryKeys.growth(filters),
    queryFn: () => userAnalyticsApi.getUserGrowthTrends(filters),
