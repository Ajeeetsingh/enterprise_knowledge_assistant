...
export function useServiceStatus(filters: AnalyticsFilterParams = {}) {
  return useQuery({
    queryKey: analyticsQueryKeys.monitoringServices(filters),
    queryFn: () => monitoringAnalyticsApi.getServiceStatus(filters),
