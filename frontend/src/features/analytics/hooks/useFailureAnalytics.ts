...
export function useFailureAnalytics(filters: AnalyticsFilterParams = {}) {
  return useQuery({
    queryKey: analyticsQueryKeys.aiFailures(filters),
    queryFn: () => aiAnalyticsApi.getFailureAnalytics(filters),
